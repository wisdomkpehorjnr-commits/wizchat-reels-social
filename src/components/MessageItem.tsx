...
const MessageItem = ({ message, onEdit, onDelete }: MessageItemProps) => {
  const { user } = useAuth();
  ...
  const canEdit = isOwn && messageAge < 5 * 60 * 1000; // 5 minutes in milliseconds
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="flex items-center justify-between mt-1">
              ...
              {canEdit && message.type === 'text' && !isEditing && (
